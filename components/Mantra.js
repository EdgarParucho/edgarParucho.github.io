    ...
    <div class="grid mx-auto xl:w-2/3">
      <div>
        <div class="bg-gradient-to-b from-teal-600 to-zinc-800 p-2 rounded-xl mx-10">
          <img class="rounded-sm object-cover" src="./assets/img/mantra-1-dark.png" alt="Mantra App in laptop">
        </div>
      ...
      <div class="grid items-end justify-between">
        <div class="absolute w-2/3 xl:w-1/3 ml-8 mb-2 bg-gradient-to-b from-white to-zinc-500 p-1 rounded-md shadow-md mx-10">
          <img class="rounded-lg object-cover" src="./assets/img/mantra-1.png" alt="Mantra App in tablet">
        </div>
        <div class="absolute w-20 sm:w-32 md:w-48 ml-4 mb-2 bg-gradient-to-t from-black to-zinc-600 p-0.5 md:p-1 rounded-xl shadow-md mx-10">
          <img class="mx-auto rounded-lg h-44 sm:h-64 md:h-96 object-cover" src="./assets/img/mantra-mob-1-dark.png" alt=" in smartphone">
        </div>
      </div>
    </div>
      ...
      <div class="grid text-lg">
        <div>
          ...
          <strong class="text-black dark:text-white">
            {{ inEnglish ? "A Help Desk web application." : "Una aplicación web de Help Desk" }}
          </strong>

          <p class="px-2 py-0.5 bg-teal-600 text-teal-500 bg-opacity-20 rounded-sm">
            {{ inEnglish ? "This project is currently owned by Microfilms Center from Venezuela."
        ...
        <div>
          ...
          <p>{{
            inEnglish ? "Mantra's general goal was to improve the management system, facing several issues that impacted the company's bottom line. With its implementation, it exceeded expectations, which led to make it also part of the company's catalog, the first of its kind."
            : "El objetivo general de Mantra era mejorar el sistema de gestión, enfrentando varios problemas que impactaban los resultados de la compañía. Con su implementación, superó las expectativas, lo que lo llevó a integrarlo al catálogo de la compañía, el primero de su tipo."
          }}</p>
        ...
        <dl class="mt-8 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
          <div class="dark:bg-opacity-30 shadow-md bg-white dark:bg-zinc-950 dark:shadow-zinc-950 p-4">
            <dt class="font-medium text-zinc-900 dark:text-zinc-50">
              {{ inEnglish ? "Availability" : "Disponibilidad" }}
            </dt>
            <dd class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              {{
                inEnglish ? "A web browser with internet access is all you need to use it. Plus, as a PWA (Progressive Web Application), it can be installed as a native software."
          ...
          <div class="dark:bg-opacity-30 shadow-md bg-white dark:bg-zinc-950 dark:shadow-zinc-950 p-4">
            ...
            <dd class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              {{
                inEnglish ? "Users can catch up on the service's status through cards, charts, and tables with the most relevant data according to their role."
          ...
          <div class="dark:bg-opacity-30 shadow-md bg-white dark:bg-zinc-950 dark:shadow-zinc-950 p-4">
            <dt class="font-medium text-zinc-900 dark:text-zinc-50">
              {{ inEnglish ? "Automation" : "Automatización" }}
            </dt>
            <dd class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              {{
                inEnglish ? "Avoid breach of Service Level Agreements by customizing the parameters. Mantra monitor and let you know if something is jeopardizing the service."
          ...
          <div class="dark:bg-opacity-30 shadow-md bg-white dark:bg-zinc-950 dark:shadow-zinc-950 p-4">
            ...
            <dd class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              {{ inEnglish ? "Users don't need to contact Support or Development to manage the users, products, clients nor the rest, just the right privileges."
              : "Los usuarios no necesitan contactar a Soporte o Desarrollo para gestionar clientes, usuarios o productos, solo los privilegios adecuados." }}
            </dd>
          </div>
        </dl>
